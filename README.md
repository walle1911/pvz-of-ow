...
本项目基于 [hsk-dream/PVZ-Godot-Dream](https://github.com/hsk-dream/PVZ-Godot-Dream) 进行二次开发，并保留原项目的版权与许可声明。
...
使用者需要自行准备具有合法使用权的资源，并保持项目引用所要求的目录结构与文件名。公开项目源码不代表对任何第三方素材的授权。
...
- 感谢 **hsk-dream** 开源 PVZ-Godot-Dream，为本项目提供基础代码与工程框架。
...
- 项目视频：[PVZ-OF-OW 项目展示](https://www.bilibili.com/video/BV1qA8s6GEyo/)
- Email：[walle1911@outlook.com](mailto:walle1911@outlook.com)

## 许可与版权

本项目保留上游项目的 [Custom Non-Commercial License v1.0](./LICENSE)。除第三方组件或另有说明的内容外，仓库代码仅可在该许可证约定的非商业范围内使用、复制、修改和分享。

- 原项目代码版权归 **hsk-dream** 所有。
- PVZ-OF-OW 新增的原创代码与改动版权归 **walle1911** 所有，并按上述非商业许可范围分享。
- `addons/` 等目录中具有独立许可证的第三方组件继续遵循各自的许可条款，相关版权声明必须保留。
...
项目代码许可证不授予第三方商标、角色、美术、字体、音乐、音效及其他受保护内容的使用权。
