...
const PLANT_NAME_TEXTURE_MAP = {
	...
	CharacterRegistry.PlantType.P042TwinSunFlowerIllari: preload("res://assets/image/Almanac/name_id/图层 82.png"),
	...
	CharacterRegistry.PlantType.P051CattailSierra: preload("res://assets/image/Almanac/name_id/小推车渣克女王.png"),
