...
var curr_plant :Array[CharacterRegistry.PlantType]= [
	...
	CharacterRegistry.PlantType.P053CherryBombJunkrat,
	CharacterRegistry.PlantType.P054SquashDoomfist,
	CharacterRegistry.PlantType.P055SnowPeaMei,
	CharacterRegistry.PlantType.P056GatlingPeaBastion,
	CharacterRegistry.PlantType.P057TallNutSigma,
	CharacterRegistry.PlantType.P058CattailJetpackCat,
	CharacterRegistry.PlantType.P059JalapenoVendetta,
	CharacterRegistry.PlantType.P060MelonPultAshe,
	CharacterRegistry.PlantType.P061ImitaterEcho,
	CharacterRegistry.PlantType.P062DoomShroomDVA,
	CharacterRegistry.PlantType.P063GloomShroomMoira,
	CharacterRegistry.PlantType.P064SeaShroomWuyang,
	CharacterRegistry.PlantType.P065FumeShroomRoadhog,
	CharacterRegistry.PlantType.P066MagnetShroomSombra,
	...
	CharacterRegistry.PlantType.P071GarlicMauga,
	CharacterRegistry.PlantType.P072CaltropHazard,
	CharacterRegistry.PlantType.P073TanglekelpMizuki,
...
var curr_zombie :Array[CharacterRegistry.ZombieType]= [
	...
	CharacterRegistry.ZombieType.Z026GargantuarReinhardt,
	CharacterRegistry.ZombieType.Z027ZombieYetiWinston,
	CharacterRegistry.ZombieType.Z028DiggerZombieVenture,
	CharacterRegistry.ZombieType.Z029JackboxReaper,
