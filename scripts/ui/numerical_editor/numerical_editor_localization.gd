...
const CHARACTER_NAMES := {
	...
	"GloomShroom_Moira": "莫伊拉（形态二）", "GloomShroom_Moira_Form1": "莫伊拉（形态一）", "SeaShroom_Wuyang": "海蘑菇（无漾）",
...
const PROPERTY_LABELS := {
	...
	"giant_pea_attack_value": "巨型豌豆伤害", "downpour_damage": "千针雨伤害",
	...
	"yellow_fume_heal_value": "黄色烟雾治疗量", "death_sun_value": "死亡掉落阳光价值",
	"death_sun_count": "死亡掉落阳光数量", "small_body_scale": "未成长体型倍率",
	"grown_body_scale": "成长后体型倍率", "first_sun_time_min": "第一颗阳光最短等待",
	"first_sun_time_max": "第一颗阳光最长等待", "repeat_sun_time_min": "后续阳光最短间隔",
	"repeat_sun_time_max": "后续阳光最长间隔",
	...
	"skill_column_count": "技能覆盖列数", "locked_fire_delay": "骷髅显现后开枪延迟", "charged_icon_hold_time": "锁定图标停留时间", "backstep_duration": "后撤动作时间", "backstep_roll_turns": "后撤翻滚圈数",
