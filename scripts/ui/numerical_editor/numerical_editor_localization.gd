...
const PROPERTY_LABELS := {
	...
	"damage_boost_multiplier": "蓝线增伤倍率", "damage_multiplier": "伤害倍率", "damage_boost_target_cell_max_range": "蓝线最远连接格数",
	...
	"heal_duration": "回血持续时间", "hat_cooldown": "飞帽冷却时间", "hat_flight_scale_percent": "飞行帽缩放百分比",
