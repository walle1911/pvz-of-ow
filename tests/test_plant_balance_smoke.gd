...
const REQUIRED_PANEL_FIELDS := {
	...
	24: {".": ["slam_front_cell_count", "slam_lift_height", "slam_lift_time", "slam_hold_time", "slam_fall_time", "slam_current_hp_ratio"]},
	25: {"AttackComponent": ["direct_attack_damage", "direct_attack_interval", "guidance_attack_damage", "guidance_attack_interval"]},
	27: {".": ["charge_time", "skill_trigger_hp", "max_skill_targets", "max_skill_damage", "skill_column_count"]},
	...
	36: {".": ["attack_speed_multiplier", "damage_multiplier", "boost_duration"]},
